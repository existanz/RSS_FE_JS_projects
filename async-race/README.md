# async-race
App starts [here](start.html) but first read this **↓**  
For this web application need API server.  
You can find api with mocked data in [server](https://github.com/EXisTAnZ/RSS_FE_JS_projects/tree/async-race/async-race) directory.

## Setup and Running

- Use `node 14.x` or higher.
- Install dependencies: `$ npm install`.
- Start server: `$ npm run startapi`.
...
- **Engine**
    - [Start / Stop Car's Engine](#start--stop-cars-engine)
    - [Switch Car's Engine to Drive Mode](#switch-cars-engine-to-drive-mode)
- **Winners**
    - [Get Winners](#get-winners)
    - [Get Winner](#get-winner)
    - [Create Winner](#create-winner)
